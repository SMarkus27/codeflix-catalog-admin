...
from src.django_project.cast_member.serializers import ListCastMemberResponseSerializer, \
    CreateCastMemberRequestSerializer, CreateCastMemberResponseSerializer, UpdateCastMemberRequestSerializer, \
...
class CastMemberViewSet(viewsets.ViewSet):
    ...
    def create(self, request: Request) -> Response:
        ...
        use_case = CreateCastMember(cast_member_repository=DjangoORMCastMemberRepository())
    ...
    def update(self, request: Request, pk: UUID = None):
        ...
        use_case = UpdateCastMember(cast_member_repository=DjangoORMCastMemberRepository())
        try:
    ...
    def destroy(self, request: Request, pk: UUID = None):
        ...
        use_case = DeleteCastMember(cast_member=DjangoORMCastMemberRepository())
        try:
